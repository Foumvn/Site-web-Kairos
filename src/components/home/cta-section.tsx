    ...
    <section className="py-24 bg-gradient-to-br from-blue-600 via-cyan-500 to-sky-500 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
          Join hundreds of organizations already using Kairos to implement comprehensive digital information systems that streamline operations and drive business growth.
        </p>
